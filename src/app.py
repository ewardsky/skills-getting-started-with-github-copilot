...
activities = {
    ...
    "Soccer": {
        "description": "Outdoor soccer team for all skill levels",
    ...
    "Drama Club": {
        "description": "Theater productions and dramatic performance",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["isabella@mergington.edu"]
    },
    "Music Ensemble": {
        "description": "Perform in concerts and develop musical skills",
